...
export const SEED_TOPICS_FOR_EMPTY_PILLARS: Record<PillarSlug, EditorialTopic> = {
  ...
  style: {
    id: 'lm-style-seed-01-contemporary-capsule-beauty',
    canonicalTopic: 'The Modern Capsule Wardrobe and Intentional Skincare: A Practical Guide to Everyday Style',
    ...
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    tags: ['style', 'fashion', 'skincare', 'beauty', 'wardrobe'],
  ...
  entertainment: {
    id: 'lm-entertainment-seed-01-cinema-storytelling',
    canonicalTopic: 'The Art of Modern Cinema: How Directors and Performers Shape Contemporary Stories',
    slug: 'modern-cinema-directors-performers-contemporary-stories',
    pillar: 'entertainment',
    sourceSignals: [],
    queryVariants: ['modern cinema storytelling', 'contemporary film directors and actors'],
    freshnessScore: 85,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    tags: ['entertainment', 'film', 'cinema', 'celebrity', 'television'],
    targetAudience: 'Film lovers and contemporary entertainment enthusiasts.',
    primaryIntent: 'informational',
    scoring: {
      searchPotential: 85,
      pinterestPotential: 85,
