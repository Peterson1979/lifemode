...
export const DEFAULT_AFFILIATE_CATALOG: AffiliateCatalogItem[] = [
  // Books & Thoughtful Literature
  {
    ...
    category: 'books',
    applicablePillars: ['style', 'entertainment', 'wellbeing', 'money', 'tech-ai', 'travel'],
  ...
  // Specialty Coffee & Kitchen Craft
  {
    ...
    category: 'gear',
    applicablePillars: ['food-drink', 'travel', 'style'],
    applicableIntents: ['commercial-investigation', 'transactional'],
  ...
  // Workspace & Lighting
  {
    ...
    category: 'workspace',
    applicablePillars: ['style', 'wellbeing', 'tech-ai'],
    applicableIntents: ['commercial-investigation', 'transactional'],
  ...
  // Audio & Studio Hardware
  {
    ...
    category: 'audio',
    applicablePillars: ['tech-ai', 'entertainment'],
    applicableIntents: ['commercial-investigation', 'transactional'],
  ...
  // Minimalist Luggage & Travel Packs
  {
    ...
    category: 'travel',
    applicablePillars: ['travel', 'style'],
    applicableIntents: ['commercial-investigation', 'transactional'],
    applicableFormats: ['guide', 'curation', 'listicle', 'standard'],
  ...
  // Travel Electronics & Adaptors
  {
    ...
    category: 'gear',
    applicablePillars: ['travel', 'tech-ai', 'style'],
    applicableIntents: ['commercial-investigation', 'transactional'],
  ...
  // Sleep & Rest Optimization
  {
    ...
    applicablePillars: ['wellbeing', 'style'],
    applicableIntents: ['commercial-investigation', 'transactional'],
    applicableFormats: ['guide', 'curation', 'listicle'],
